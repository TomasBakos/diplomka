...
agg_data = data.groupby("tanksalot_uid", as_index=False).agg({"base_cost":"max", "country":"count", "client_timestamp": "max"})
agg_data = agg_data.rename(index=str, columns={"base_cost": "pay_max", "country": "pay_count", "client_timestamp": "pay_latest"})
...
agg_data.to_csv("data/rfm_kmeans_maxbuy.csv")